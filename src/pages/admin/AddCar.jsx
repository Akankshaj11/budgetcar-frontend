...
const AddCar = () => {
  ...
  const handleCoverChange = (e) => {
    ...
    setImage(file); // actual file for Cloudinary

    const reader = new FileReader();

    reader.onload = () => {
      setCoverImage(reader.result); // preview only
    };
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                <button
                  ...
                  className={`px-4 py-3 rounded-xl border text-xs font-bold transition duration-300 text-center cursor-pointer ${featuresList[feat.key]
