...
const AllDeals = () => {
        ...
        return {
            ...
            "@graph": [
                getBreadcrumbJsonLd([
                    ...
                    { name: "Deals", url: `${siteUrl}/all-deals` },
                ]),
                {
                    "@type": "CollectionPage",
                    name: PAGE_SEO.allDeals.title,
                    description: PAGE_SEO.allDeals.description,
                    url: `${siteUrl}/all-deals`,
    ...
    return (
        <>
            <SEO
                title={PAGE_SEO.allDeals.title}
                description={PAGE_SEO.allDeals.description}
                keywords={PAGE_SEO.allDeals.keywords}
                jsonLd={jsonLd}
            />
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500 max-w-xl">
                                    Grab the best savings on our handpicked certified pre-owned cars.
                                </p>
                            </div>
                        ...
                        <div className="lg:col-span-3">
                            {filteredDeals.length === 0 ? (
                                <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center shadow-xs">
                                    ...
                                    <p className="text-sm text-gray-500 mb-6 max-w-sm mx-auto">We couldn't find any deals matching your current filters. Try resetting the filters or broadening your search query.</p>
                                    <button 
                                        onClick={handleReset}
